      ...
      <div className="w-full max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-row justify-center items-center gap-2 sm:gap-6 lg:gap-8 mb-8 min-h-[120px] pt-2 overflow-x-auto">
          <a
            ...
            className="group flex flex-col items-center hover:bg-white/10 rounded-xl p-2 sm:p-4 transition-all duration-300 hover:scale-105 flex-shrink-0 min-w-[80px] sm:min-w-0"
          >
            <div className="w-8 h-8 sm:w-12 sm:h-12 bg-white/20 rounded-full flex items-center justify-center group-hover:bg-[#F1C40F] group-hover:text-[#1e4395] transition-all duration-300 mb-2 sm:mb-3">
              <svg className="w-4 h-4 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
              </svg>
            </div>
            <span className="text-white/90 group-hover:text-white font-medium text-xs sm:text-base text-center">Website</span>
          </a>
          ...
          >
            ...
            <span className="text-white/90 group-hover:text-white font-medium text-xs sm:text-base text-center">Instagram</span>
          </a>
          ...
          >
            ...
            <span className="text-white/90 group-hover:text-white font-medium text-xs sm:text-base text-center">Facebook</span>
          </a>
        </div>
